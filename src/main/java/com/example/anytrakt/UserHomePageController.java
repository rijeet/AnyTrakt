...
public class UserHomePageController implements Initializable {
    ...
    void onAnime_btnClick(ActionEvent event)throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("User_Anime_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }

    @FXML
    void onComic_btnClick(ActionEvent event) throws IOException{
        Parent pane = FXMLLoader.load(getClass().getResource("User_Comic_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }

    @FXML
    void onDrama_btnClick(ActionEvent event)throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("User_Drama_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }

    @FXML
    void onManga_btnClick(ActionEvent event)throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("User_Manga_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }

    @FXML
    void onMovie_btnClick(ActionEvent event)throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("User_Movie_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }

    @FXML
    void onNonfiction_btnClick(ActionEvent event) throws IOException{
        Parent pane = FXMLLoader.load(getClass().getResource("User_Nonfiction_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }
    ...
    void onTv_btnClick(ActionEvent event)throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("User_Tv_Series_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }

    @FXML
    void onFiction_btnClick(ActionEvent event) throws IOException{
        Parent pane = FXMLLoader.load(getClass().getResource("User_Fiction_List_Table.fxml"));
        show_table_pane.getChildren().setAll(pane);
    }
