...
public class UserMovieStatusTableController implements Initializable {
    ...
    @FXML
    private TableView<Watch_List_OnStatus> Movie_Table;
    ...
    static ObservableList<Watch_List_OnStatus> UserOnStatusMovielist= FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try{
            UserMovieStatusTableController.UserOnStatusMovielist=  dbAction.getAllMovieOnStatus();
...
//Author
        ...
        Movie_Table.setItems(UserMovieStatusTableController.UserOnStatusMovielist);
    }


    @FXML
    void Delete_button_Action_User_movie_Status(ActionEvent event) throws SQLException{
        ObservableList<Watch_List_OnStatus> selectedMovie=FXCollections.observableArrayList();
        selectedMovie=Movie_Table.getSelectionModel().getSelectedItems();
        DB_Connection dbAction=new DB_Connection();
        dbAction.deleteOnStatusUserMovie(selectedMovie);
        UserMovieStatusTableController.UserOnStatusMovielist.removeAll(selectedMovie);
    }
    ...
    void GroupByCompleted(ActionEvent event) throws SQLException{
        ...
        ObservableList<Watch_List_OnStatus> selectedMovie=FXCollections.observableArrayList();
        DB_Connection dbAction=new DB_Connection();
        selectedMovie =  dbAction.getAllMovieGroupByCompleted();
    ...
    void GroupByPlan_To_Watch(ActionEvent event) throws SQLException{
        ...
        ObservableList<Watch_List_OnStatus> selectedMovie=FXCollections.observableArrayList();
        DB_Connection dbAction=new DB_Connection();
        selectedMovie =  dbAction.getAllMovieGroupByPlan_To_Watch();
    ...
    void GroupByWatch(ActionEvent event) throws SQLException{
        ...
        ObservableList<Watch_List_OnStatus> selectedMovie=FXCollections.observableArrayList();
        DB_Connection dbAction=new DB_Connection();
        selectedMovie =  dbAction.getAllMovieGroupByWatching();
    ...
    @FXML
    void Search_button_Action_User_movie_Status(ActionEvent event) throws SQLException{
        String Type=Search_type_comboBox.getValue();
        String value=Search_value.getText();
        ObservableList<Watch_List_OnStatus> selectedMovie=FXCollections.observableArrayList();
        DB_Connection dbAction=new DB_Connection();
        selectedMovie  = dbAction.searchOnStatusMovie(Type, value);
